...
- 難易度の表示は SAA 版と同じ 基礎/中間/本番同等(d=1/2/3。作問の目安は 基礎用語/産地・品種の対応/細かい数値・法規)
- EXP: 基礎 6/1、中間 10/2、本番同等 16/3(正解/不正解)。Lv N→N+1 = 100 + 2(N-1)、Lv100 まで累計 19,602 EXP
...
## 機能
- 分野指定 / 全分野ランダム(難易度 基礎・中間・本番同等も選択可。未選択なら全難易度からランダム)、復習モード(最後に解いたとき不正解だった問題)、模試モード(比重どおり 120問・70分 / ミニ 30問・18分)
